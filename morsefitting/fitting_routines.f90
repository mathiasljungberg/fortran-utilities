...
!      freq = sqrt(2.*D_SI/my_SI)*a_SI*cm*hbar
    ...
    subroutine coeff3(d,a,d3,p2,p3,p4)
      use parameters
      implicit none
!     rutinen beräknar 2:a ,3:e och 4:e koefficienterna i taylorutvecklingen 
!     för fjärdegradspolynomet i morsevariabeln 
!     p2 [Hartree*Å-2], p3 [Hartree*Å-3],p4 [Hartree*Å-4]
!     derivatorna är p2*2 p3*6 och p4*24 
!     d =D och a =alfa, my är reducerade massan 
!     amu=1.659913245226400e-27, gammal definition
...
!      freq = sqrt(2.*D_SI/my_SI)*a_SI*cm*hbar
      p2 =  d*a**2 
      p3 = -d*a**3  + d3*a**3
      p4 =  (7./12.)*d*a**4 - (3./2.)*d3*a**4  

      return
    end subroutine coeff3


    subroutine coeff4(d,a,d3,d4,p2,p3,p4)
      use parameters
      implicit none
!     rutinen beräknar 2:a ,3:e och 4:e koefficienterna i taylorutvecklingen 
!     för fjärdegradspolynomet i morsevariabeln 
...
!      freq = sqrt(2.*D_SI/my_SI)*a_SI*cm*hbar
      p2 =  d*a**2 
      p3 = -d*a**3  + d3*a**3
      p4 =  (7./12.)*d*a**4 - (3./2.)*d3*a**4  +d4*a**4
